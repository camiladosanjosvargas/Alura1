...
(defn cartoes []
  [{:cartao 10, :cliente 1 :numero "908976", :CVV 989, :validade (data 2022 01 12), :limite 100},
   {:cartao 50, :cliente 1 :numero "7646378", :CVV 546, :validade (data 2022 01 12), :limite 500},
   {:cartao 20, :cliente 2 :numero "4563575", :CVV 764, :validade (data 2022 01 12), :limite 200},
   {:cartao 30, :cliente 3 :numero "753567", :CVV 643, :validade (data 2022 01 12), :limite 300},
   {:cartao 40, :cliente 4 :numero "845354", :CVV 123, :validade (data 2022 01 12), :limite 400}])

(defn todas-as-compras []
  [{:id 1, :cartao 10, :detalhes {:data (data 2021 01 12), :valor 80, :estabelecimento "EscolaABC", :categoria "Educação"}},
