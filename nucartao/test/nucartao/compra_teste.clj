...
;erro ao comparar o campo de data
;(deftest nova-compra-detalhada-teste
;  (testing "teste da funcao que adiciona nova compra"
;    (is (= [{:id 1, :cartao 10, :detalhes {:data (data 2020 10 02), :valor 80, :estabelecimento "EscolaABC", :categoria "Educação"}},
...
(deftest detalhar-compras-do-cartao-teste
  (testing "Formato de retorno válido - teste da funcao que detalha todas as compras do cartao"
    (is (= {:cliente 1,
            ...
            [{"Educação" "R$ 80.00"} {"Saúde" "R$ 5.00"}],
            :compras-realizadas
            [{:data (data 2020 10 02),
              :valor 80,
